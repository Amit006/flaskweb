...
app.config['MAIL_PASSWORD'] = 'shabby12'
app.config['MAIL_DEFAULT_SENDER '] = 'shahbazaslam708@gmail.com'
...
def SignUp():
    msg = Message('Hey There', recipients=['geharo4594@hubopss.com'])
    mail.send(msg)

    return 'messege has been sent'
#
#     form = SignUpFrom(request.form)
#
...
#               # #  mail.send_message('New Message from'+ username,sender=email,
#               #                     recipients = ('shahbazaslam708@gmail.com'),
#               #                     body='messages' +'\n' + email)
